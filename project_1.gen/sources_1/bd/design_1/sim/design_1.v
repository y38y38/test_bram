...
module design_1
  ...
  wire [31:0]myip_0_INPUT_ADDRESS;
  wire [31:0]myip_0_OUTPUT_ADDRESS;
  wire myip_0_START;
  wire [0:0]rst_ps8_0_100M_peripheral_aresetn;
  wire [31:0]signal_controller_0_ADDRB;
  wire signal_controller_0_CLKB;
  wire [31:0]signal_controller_0_DINB;
  wire signal_controller_0_ENB;
  wire signal_controller_0_RSTB;
  wire [3:0]signal_controller_0_STATUS;
  wire [31:0]signal_controller_0_STATUS2;
  wire [3:0]signal_controller_0_WEB;
  ...
  design_1_blk_mem_gen_0_0 blk_mem_gen_0
       (.addra({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,axi_bram_ctrl_0_BRAM_PORTA_ADDR}),
        .addrb(signal_controller_0_ADDRB),
        .clka(axi_bram_ctrl_0_BRAM_PORTA_CLK),
        .clkb(signal_controller_0_CLKB),
        .dina(axi_bram_ctrl_0_BRAM_PORTA_DIN),
        .dinb(signal_controller_0_DINB),
        .douta(axi_bram_ctrl_0_BRAM_PORTA_DOUT),
        .doutb(blk_mem_gen_0_doutb),
        .ena(axi_bram_ctrl_0_BRAM_PORTA_EN),
        .enb(signal_controller_0_ENB),
        .rsta(axi_bram_ctrl_0_BRAM_PORTA_RST),
        .rstb(signal_controller_0_RSTB),
        .wea(axi_bram_ctrl_0_BRAM_PORTA_WE),
        .web(signal_controller_0_WEB));
  design_1_myip_0_0 myip_0
       (.INPUT_ADDRESS(myip_0_INPUT_ADDRESS),
        .OUTPUT_ADDRESS(myip_0_OUTPUT_ADDRESS),
        .START(myip_0_START),
        .STATUS1({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,signal_controller_0_STATUS}),
        .STATUS2(signal_controller_0_STATUS2),
  ...
  design_1_signal_controller_0_0 signal_controller_0
       (.ADDRB(signal_controller_0_ADDRB),
        .CLKB(signal_controller_0_CLKB),
        ...
        .DOUTB(blk_mem_gen_0_doutb),
        .ENB(signal_controller_0_ENB),
        .INPUT_RAM_ADDRESS(myip_0_INPUT_ADDRESS),
        .OUTPUT_RAM_ADDRESS(myip_0_OUTPUT_ADDRESS),
        .RESET(rst_ps8_0_100M_peripheral_aresetn),
        .RSTB(signal_controller_0_RSTB),
        .START(myip_0_START),
        .STATUS(signal_controller_0_STATUS),
        .STATUS2(signal_controller_0_STATUS2),
        .WEB(signal_controller_0_WEB));
